...
namespace Assistant
{
    ...
    public class SpecialMoves
    {
        ...
        private static readonly int[] HatchetID = {0xF43, 0xF44};
        private static readonly int[] LongSwordID = {0xF60, 0xF61};
        private static readonly int[] BroadswordID = {0xF5E, 0xF5F};
        private static readonly int[] KatanaID = {0x13FE, 0x13FF};
        private static readonly int[] BladedStaffID = {0x26BD, 0x26C7};
        private static readonly int[] HammerPickID = {0x143C, 0x143D};
        private static readonly int[] WarAxeID = {0x13AF, 0x13B0};
        private static readonly int[] KryssID = {0x1400, 0x1401};
        private static readonly int[] SpearID = {0xF62, 0xF63};
        private static readonly int[] CompositeBowID = {0x26C2, 0x26CC};
        private static readonly int[] CleaverID = {0xEC2, 0xEC3};
        private static readonly int[] LargeBattleAxeID = {0x13FA, 0x13FB};
        private static readonly int[] BattleAxeID = {0xF47, 0xF48};
        private static readonly int[] ExecAxeID = {0xF45, 0xF46};
        private static readonly int[] CutlassID = {0x1440, 0x1441};
        private static readonly int[] ScytheID = {0x26BA, 0x26C4};
        private static readonly int[] WarMaceID = {0x1406, 0x1407};
        private static readonly int[] PitchforkID = {0xE87, 0xE88};
        private static readonly int[] WarForkID = {0x1404, 0x1405};
        private static readonly int[] HalberdID = {0x143E, 0x143F};
        private static readonly int[] MaulID = {0x143A, 0x143B};
        private static readonly int[] MaceID = {0xF5C, 0x45D};
        private static readonly int[] GnarledStaffID = {0x13F8, 0x13F9};
        private static readonly int[] QuarterStaffID = {0xE89, 0xE8A};
        private static readonly int[] LanceID = {0x26C0, 0x26CA};
        private static readonly int[] CrossbowID = {0xF4F, 0xF50};
        private static readonly int[] VikingSwordID = {0x13B9, 0x13BA};
        private static readonly int[] AxeID = {0xF49, 0xF4A};
        private static readonly int[] ShepherdsCrookID = {0xE81, 0xE82};
        private static readonly int[] SmithsHammerID = {0x13EC, 0x13E4};
        private static readonly int[] WarHammerID = {0x1438, 0x1439};
        private static readonly int[] ScepterID = {0x26BC, 0x26C6};
        private static readonly int[] SledgeHammerID = {0xFB4, 0xFB5};
        private static readonly int[] ButcherKnifeID = {0x13F6, 0x13F7};
        private static readonly int[] PickaxeID = {0xE85, 0xE86};
        private static readonly int[] SkinningKnifeID = {0xEC4, 0xEC5};
        private static readonly int[] WandID = {0xDF2, 0xDF3, 0xDF4, 0xDF5};
        private static readonly int[] BardicheID = {0xF4D, 0xF4E};
        private static readonly int[] ClubID = {0x13B3, 0x13B4};
        private static readonly int[] ScimitarID = {0x13B5, 0x13B6};
        private static readonly int[] HeavyCrossbowID = {0x13FC, 0x13FD};
        private static readonly int[] TwoHandedAxeID = {0x1442, 0x1443};
        private static readonly int[] DoubleAxeID = {0xF4B, 0xF4C};
        private static readonly int[] CrescentBladeID = {0x26C1, 0x26C2};
        private static readonly int[] DoubleBladedStaffID = {0x26BF, 0x26C9};
        private static readonly int[] RepeatingCrossbowID = {0x26C3, 0x26CD};
        private static readonly int[] DaggerID = {0xF51, 0xF52};
        private static readonly int[] PikeID = {0x26BE, 0x26C8};
        private static readonly int[] BoneHarvesterID = {0x26BB, 0x26C5};
        private static readonly int[] ShortSpearID = {0x1402, 0x1403};
        private static readonly int[] BowID = {0x13B1, 0x13B2};
        private static readonly int[] BlackStaffID = {0xDF0, 0xDF1};
        private static readonly int[] FistsID = {0};

        private static readonly AbilityInfo[] m_Primary =
        {
        ...
        private static readonly AbilityInfo[] m_Secondary =
        {
        ...
        {
            HotKey.Add(HKCategory.Misc, HKSubCat.None, LocString.ToggleWarPeace, ToggleWarPeace);

            HotKey.Add(HKCategory.Misc, HKSubCat.SpecialMoves, LocString.ClearAbility, ClearAbilities);

            HotKey.Add(HKCategory.Misc, HKSubCat.SpecialMoves, LocString.SetPrimAb, SetPrimaryAbility);
            HotKey.Add(HKCategory.Misc, HKSubCat.SpecialMoves, LocString.SetSecAb, SetSecondaryAbility);

            HotKey.Add(HKCategory.Misc, HKSubCat.SpecialMoves, LocString.ToggleStun, OnStun);
            HotKey.Add(HKCategory.Misc, HKSubCat.SpecialMoves, LocString.ToggleDisarm, OnDisarm);
        }
