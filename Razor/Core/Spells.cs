...
namespace Assistant
{
    public class Spell
    {
        ...
        private static readonly HotKeyCallbackState HotKeyCallback;
        ...
        static Spell()
        {
            ...
            HotKey.Add(HKCategory.Spells, LocString.HealOrCureSelf, HealOrCureSelf);
            HotKey.Add(HKCategory.Spells, LocString.MiniHealOrCureSelf, MiniHealOrCureSelf);
            HotKey.Add(HKCategory.Spells, LocString.Interrupt, Interrupt);
        }
        ...
        {
            return string.Format("{0} (#{1})", Language.GetString(Name), GetID());
        }
