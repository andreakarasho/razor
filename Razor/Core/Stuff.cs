...
#warning Extra special leet stuff is enabled.  Don't release this build.
		...
		public static void ResetFind( string[] args )
		{
			...
			ClientCommunication.PostMessage( ClientCommunication.UOWindow, ClientCommunication.WM_UONETEVENT, (IntPtr)wParam, IntPtr.Zero );
		}
		...
		public static void Find( string[] args )
		{
			try
			{
				...
				ClientCommunication.PostMessage( ClientCommunication.UOWindow, ClientCommunication.WM_UONETEVENT, (IntPtr)(((uint)ClientCommunication.UONetMessage.FindData)|(((uint)size)<<16)), (IntPtr)((int)val) );
			}
			catch ( Exception e )
			{
